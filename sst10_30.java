...
public static void main(String[] args)
        ...
        } while (!game.gametype.equals("regular") && !game.gametype.equals("tournament") && !game.gametype.equals("frozen"));
        ...
        } while (!game.rank.equals("novice") && !game.rank.equals("fair") && !game.rank.equals("good") && !game.rank.equals("expert") && !game.rank.equals("emeritus"));
...
class Game
{
	...
	public void MOVE() {
        ...
        */
        ...
        if((quadrant.row + xpos) < 1 || (quadrant.row + xpos) > 8 || (quadrant.column + ypos) < 1 || (quadrant.column + ypos) > 8)
        {
	...
	public void PHASERS() {
        ...
        else if(klingon.row < (quadrant.row +1) && klingon.row > (quadrant.row -1) && klingon.column < (quadrant.row +1) && klingon.column > (quadrant.row -1) )  //if it is in a quadrant next to us
        {
	...
	public void CHART() {
        ...
        //System.out.println("\nEnterprise is currently in Quadrant " + ___ + " - " + ___ +);
	}
